...
- (void)testRutFormat
{
    ...
    XCTAssertTrue([[rutTextField getRutConVerificador:NO] isEqualToString:@"16095783"]);
    
    rutTextField.text = @"6066675k";
    XCTAssertTrue([[rutTextField getRutConVerificador:YES] isEqualToString:@"6.066.675-K"]);
    XCTAssertTrue([[rutTextField getRutConVerificador:NO] isEqualToString:@"6066675"]);
    
    rutTextField.text = @"62273518";
    XCTAssertTrue([[rutTextField getRutConVerificador:YES] isEqualToString:@"6.227.351-8"]);
    XCTAssertTrue([[rutTextField getRutConVerificador:NO] isEqualToString:@"6227351"]);
}
...
- (void)testAutentificacionExist
{
    ...
    passwordTextField.text = @"NADA POR AHORA";
